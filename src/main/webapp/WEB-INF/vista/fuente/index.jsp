...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <base href="/autoevaluacion">
        <meta charset="utf-8" http-equiv="Refresh" content="<c:out value="${samlLink}" />
              </head>
              <body>
              <!--[if lt IE 7]>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" style="padding-top: 10px; padding-bottom: 5px;"><img src="<%=request.getContextPath()%>/img/LETRAS.png"/></a>
